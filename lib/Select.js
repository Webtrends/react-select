...
var Select = React.createClass({
    ...
    getDefaultProps: function() {
        return {
            ...
            optionFooter: undefined,
            optionComponentClass: undefined
        };
    },
    ...
    buildMenu: function() {
        ...
        var ops = _.map(this.state.filteredOptions, function(op) {
            ...
            if (this.props.optionComponentClass) {
                ...
                return React.createElement(OptionComponent, {ref: ref, 
                    source: op, 
                    key: 'option-' + op.value, 
        ...
        if (this.props.optionFooter) {
            ops.push(this.props.optionFooter);
        }
    ...
    render: function() {
        ...
        if (this.state.isOpen) {
            ...
            menu = (
                React.createElement("div", {className: "Select-menu-outer"}, 
